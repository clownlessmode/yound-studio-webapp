...
const Page = () => {
  ...
  return (
    <>
      <main className="pb-[40px] flex-1 overflow-y-auto h-full flex-grow px-[15px] w-full flex flex-col bg-[#C5F3AB]">
        ...
        <section className="bg-white rounded-[30px]  w-full p-[25px] font-semibold text-[24px] text-[#202022]">
          ...
          <p className="font-medium text-[16px] text-[#202022] leading-[19px]">
            ...
            доступно в внутри Телеграма. <br /> Здесь можно создать полноценное
            приложение. Например, онлайн-магазин, игру или сервис для клиентов.
            Все, что угодно. Представьте, что вы в App Store или Google Play, вы
            устанавливаете любое приложение и пользуйетесь им. Теперь это не
            нужно, все доступно в внутри Телеграма.
          </p>
        </section>
      </main>
      <ContactFooter />
